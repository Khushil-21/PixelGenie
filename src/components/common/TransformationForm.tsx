...
export default function TransformationForm({ data = null, action, type, userId, creditBalance }: TransformationFormProps) {
    ...
    function onSelectFieldHandler(value: string, onChange: (value: string) => void) {
        console.log(value)
        onChange(value)
    }
