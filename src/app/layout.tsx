...
export const metadata: Metadata = {
	title: "Pixel Genie",
	description:
		"AI powered image generator with tools for background removal, image enhancement, object removal, generative fill, and object recoloring",
	keywords: [
		"AI image generator",
		"background removal",
		"image enhancement",
	...
	openGraph: {
		...
		description:
			"Transform your images with AI-powered tools for background removal, enhancement, object removal, and more",
		images: [
			{
